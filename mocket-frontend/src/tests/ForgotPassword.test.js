...
test("component renders correctly", async () => {
    ...
    expect(container.querySelector(".mocket-forgot-button")).toBeInTheDocument();
...
test("calls forgotten password service on valid input", async () => {
    ...
    fireEvent.click(container.querySelector(".mocket-forgot-button"));
...
test("does not call forgotten password service on invalid input, alert shown", async () => {
    ...
    await act(() => fireEvent.click(container.querySelector(".mocket-forgot-button")));
